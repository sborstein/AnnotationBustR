...
## NEW FEATURES
* AnnotationBustR 2.0 now uses rentrez to provide access to sequences. This offers access to the latest versions of GenBank and connection stability.
* AnnotationBustR 2.0 now uses various BioConductor packages as dependencies for parsing annotations, providing speed increases and access to more feature types.
